...
public class OpenAddrQuad {// Quad Probing
	...
	public int hashInsert(int d) {
		...
		if(table[hashCode]==-1) { // 값이 없으면
			...
			while(table[probeIndex]!=-1 && table[probeIndex]!=-999) {
				nOfHops++;
				quadProb++;
				probeIndex = ((probeIndex+quadProb*quadProb)%tableSize);
...
//	enlargeTable
	...
	public static void main(String[] args) {
		...
		OpenAddrQuad myHash = new OpenAddrQuad(tableSize);
		// Insert
		int sumOfSuccess = 0;
		int sumOfFailure = 0;
		int maxCount = 0;

...
public class SimpleBinaryTree {
	...
	public void showTree(TreeNode t) { // tree show.
		if(t!=null) {
			showTree(t.left);
	...
	public void treeInArray(TreeNode t) { // show tree in array
	...
	private void convert(TreeNode t, char[] treeArray, int i) { // convert tree
		if(t!=null) {
			treeArray[i] = t.data;
